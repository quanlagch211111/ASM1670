...
namespace ASM1670.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private static ASM1670Context _context;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            var existingUser = await FindByPhoneNumberAsync(Input.PhoneNumber.ToString());
        ...
        private static async Task<ApplicationUser> FindByPhoneNumberAsync(string phoneNumber)
        {
